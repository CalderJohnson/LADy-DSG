...
import argparse
import eval, filter, generate, llm
from params import settings
from imported import review, semeval

def load(params):
    """Loads the base dataset of reviews for filtering and labeling"""
    reviews = semeval.SemEvalReview.load(params["path"], params["explicit"], params["implicit"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", type=str, default="../data/semeval/toy.2016SB5/ABSA16_Restaurants_Train_SB1_v2.xml", help="Path to the file or directory")
    parser.add_argument("--category", type=str, default="restaurant", help="Category name")
    parser.add_argument("--model", type=str, default="gpt-4o-mini", help="Model name")
    parser.add_argument("--implicit", type=bool, default=True, help="Whether to generate implicit aspects")
    parser.add_argument("--explicit", type=bool, default=True, help="Whether to generate explicit aspects")
    ...
    settings["dsg"]["explicit"] = args.explicit
